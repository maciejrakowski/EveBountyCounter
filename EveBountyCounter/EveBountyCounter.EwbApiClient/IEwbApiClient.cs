...
public interface IEwbApiClient
{
    ...
    Task<RealtimeBountyUpdateResponse?> SubmitBountyAsync(string apiKey, decimal bountyAmount);
    ...
    Task<RealtimeBountyUpdateResponse?> SubmitBountyAsync(string apiKey, string characterId, decimal bountyAmount);
